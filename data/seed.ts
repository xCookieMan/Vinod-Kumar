...
const experienceSeed = [
  ...
  },
  {
    ...
    category: 'Freelance',
    description:
      'At PRIA, Vinod led the audio-visual section for participatory development programmes. He produced educational content and helped teams document community workshops through professional video and still photography.',
    thumbnail: '',
    media: [],
    order: 2
  },
  {
    ...
    category: 'Production',
    description:
      'As Technical Incharge at Angel Audio Visual Studio, he managed studio operations, camera setups, and maintenance. He supported television production workflows across shoots and editing sessions.',
    thumbnail: '',
    media: [],
    order: 3
  },
  {
    ...
    category: 'Production',
    description:
      'For TEZ Television, Vinod captured news coverage and field stories as a camera person. His work focused on technically reliable and visually composed footage for broadcast delivery.',
    thumbnail: '',
    media: [],
    order: 4
  },
  {
    ...
    category: 'Production',
    description:
      'At RYAN TV, he supported school-based broadcast projects and educational media initiatives. He coordinated production logistics and assisted with camera, lighting, and audio setup.',
    thumbnail: '',
    media: [],
    order: 5
  },
  {
    ...
    category: 'Academic',
    description:
      'In this academic production role, Vinod combined studio support with camera operation duties. He helped students and faculty create video content while maintaining studio equipment and workflows.',
    thumbnail: '',
    media: [],
    order: 6
  },
  {
    ...
    category: 'Academic',
    description:
      'As Studio Incharge at JIMS, he supervised studio production and trained students in television and film technology. He kept the learning environment aligned with professional broadcast standards.',
    thumbnail: '',
    media: [],
    order: 7
  },
  {
    ...
    category: 'Production',
    description:
      'Vinod managed logistics and production coordination for the Hindi feature film "Chooda Ek Paratha." He oversaw schedules, equipment, and crew support during filming.',
    thumbnail: '',
    media: [],
    order: 8
  },
  {
    ...
    category: 'Academic',
    description:
      "At Lingaya's Lalita Devi Institute, he maintained studio operations and guided media students in practical production exercises. His role centered on technical studio training and facility readiness.",
    thumbnail: '',
    media: [],
    order: 9
  },
  {
    ...
    category: 'Academic',
    description:
      'As Assistant Professor, Vinod taught media production and television technology courses. He mentored students on camera, editing, and studio craft at Madhu Bala Institute.',
    thumbnail: '',
    media: [],
    order: 10
  },
  {
    ...
    category: 'Academic',
    description:
      'During his tenure at Subharti University, he taught audiovisual production. He also provided practical training in media equipment handling and content creation.',
    thumbnail: '',
    media: [],
    order: 11
  },
